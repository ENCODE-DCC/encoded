...
class Experiments(Collection):
    ...
    class Item(Collection.Item):
        ...
        embedded = set(['files', 'replicates.antibody', 'replicates.library.documents.lab', 'replicates.library.documents.submitted_by', 'replicates.library.documents.award', 'replicates.library.biosample.donor.organism', 'replicates.library.biosample.submitted_by', 'submitted_by', 'lab', 'award', 'possible_controls', 'target.organism', 'documents.lab', 'documents.award', 'documents.submitted_by'])
        rev = {
