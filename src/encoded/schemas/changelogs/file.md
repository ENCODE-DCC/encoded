...
* Added *topic gene weights*, *cell topic participation*, *motif clusters reference*, *phastcons score reference*, *Transposable Element TF ancestral origin percent by motif*, *Transposable Element TF ancestral origin percent by subfamily*, *repeats reference*, and *variant reference* to enum list for *output_type*.
