...
* Added *enhancer-gene links* and *thresholded links* enums to output_types. Added a dependency restriction where thes output_types should only be allowed for bigInteract and bedpe files.
