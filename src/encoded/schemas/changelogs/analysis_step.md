...
* Added *genic features quantifications* to enum list for *input_file_types* and *output_file_types*.
...
* Added *predicted 3D structural ensembles* and *fold over change matrix* to the enum list for *input_file_types* and *output_file_types*.
* Added *representative IDR thresholded peaks* to the enum list for *input_file_types* and *output_file_types*.
