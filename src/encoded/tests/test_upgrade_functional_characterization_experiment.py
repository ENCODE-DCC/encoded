...
def test_functional_characterization_experiment_upgrade_9_to_10(upgrader, pooled_clone_sequencing):
    value = upgrader.upgrade('functional_characterization_experiment', pooled_clone_sequencing, current_version='9', target_version='10')
