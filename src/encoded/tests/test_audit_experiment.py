...
def file_fastq(testapp, lab, award, base_experiment, base_replicate):
    item = {
        ...
        'file_format': 'fastq',
        'md5sum': '179805a7058ee3d164702ef29df619b4',
        'output_type': 'reads',
...
def file_fastq_2(testapp, lab, award, base_experiment, base_replicate):
    item = {
        ...
        'replicate': base_replicate['@id'],
        'file_format': 'fastq',
        'md5sum': '704b76f4fe469ce32e5c3c25d172ffa1',
...
def file_fastq_4(testapp, lab, award, base_experiment, replicate_2_1):
    item = {
        ...
        'file_format': 'fastq',
        'md5sum': '3655b175700350c795de6706d6a6c3c0',
        'run_type': "paired-ended",
        'output_type': 'reads',
        'lab': lab['@id'],
        'award': award['@id'],
...
def file_fastq_5(testapp, lab, award, base_experiment, replicate_2_1):
    item = {
        ...
        'replicate': replicate_2_1['@id'],
        'file_format': 'fastq',
        'md5sum': '588f1f67b98a2ff91bddd0d97512587d',
        'run_type': "paired-ended",
        'output_type': 'reads',
        'lab': lab['@id'],
        'award': award['@id'],
...
def file_bam_2_1(testapp, encode_lab, award, base_experiment, file_fastq_4):
    item = {
        ...
        'file_format': 'bam',
        'assembly': 'mm10',
        'md5sum': '6a24cca17c2cee76f27439430d784996',
        'output_type': 'alignments',
        'lab': encode_lab['@id'],
        'award': award['@id'],
        'status': 'in progress',  # avoid s3 upload codepath
...
def file_bed_methyl(base_experiment, award, encode_lab, testapp, analysis_step_run_bam):
    item = {
        ...
        "file_size": 66569,
        "assembly": "mm10",
        "md5sum": "100d8c998f00bfdf2204e980ecf8bc26",
...
def file_tsv_1_2(base_experiment, award, encode_lab, testapp, analysis_step_run_bam):
    item = {
        ...
        'md5sum': 'eb441b15a1706d98bdbe7d188706e40a',
...
def file_tsv_1_1(base_experiment, award, encode_lab, testapp, analysis_step_run_bam):
    item = {
        ...
        'assembly': 'mm10',
        'genome_annotation': 'M4',
        'md5sum': 'ad257543dcb279d0b03b25ac830510d3',
        'output_type': 'gene quantifications',
        'award': award['uuid'],
        'lab': encode_lab['uuid'],
        'status': 'released',
