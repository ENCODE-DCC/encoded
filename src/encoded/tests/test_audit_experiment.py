...
def test_audit_experiment_MAD_long_rna_standards(testapp,
    ...
    for error_type in errors:
        errors_list.extend(errors[error_type])
    assert any(error['category'] == 'long RNA - insufficient MAD value' for error in errors_list) and \
        any(error['category'] == 'long RNA - insufficient spearman correlation' for error in errors_list)
    ...
    for error_type in errors:
        ...
        for e in errors[error_type]:
            ...
            if (e['category'].startswith('ChIP-seq')):
                print (e)
        '''
    assert any(error['category'] == 'ChIP-seq - insufficient library complexity' for error in errors_list)
...
def test_audit_experiment_wgbs_standards(testapp,
    ...
    for error_type in errors:
        errors_list.extend(errors[error_type])
    assert any(error['category'] == 'WGBS - high lambda C methylation ratio' for error in errors_list)
