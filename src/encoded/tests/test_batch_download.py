...
def test_batch_download_ensure_experiment_downloads_correctly(testapp, workbook):
    response = testapp.get('/batch_download/type%3DExperiment%26format%3Djson')
    assert response.body.decode('utf-8') == ('http://localhost/metadata/type%3DExperiment%26format%3Djson/metadata.tsv'
...
def test_batch_download_ensure_experiment_status_released_downloads_correctly(testapp, workbook):
    response = testapp.get('/batch_download/type%3DExperiment%26status%3Dreleased%26format%3Djson')
    assert response.body.decode('utf-8') == (
        'http://localhost/metadata/type%3DExperiment%26status%3Dreleased%26format%3Djson/metadata.tsv'
        '\nhttp://localhost/files/ENCFF002MWZ/@@download/ENCFF002MWZ.bam'
        '\nhttp://localhost/files/ENCFF002MXF/@@download/ENCFF002MXF.fastq.gz'
        '\nhttp://localhost/files/ENCFF946MFS/@@download/ENCFF946MFS.tsv'
        '\nhttp://localhost/files/ENCFF413RGP/@@download/ENCFF413RGP.tsv'
...
def test_batch_download_ensure_experiment_status_archived_downloads_correctly(testapp, workbook):
    response = testapp.get('/batch_download/type%3DExperiment%26status%3Darchived%26format%3Djson')
    assert response.body.decode('utf-8') == (
        'http://localhost/metadata/type%3DExperiment%26status%3Darchived%26format%3Djson/metadata.tsv'
    )

def test_batch_download_ensure_experiment_status_revoked_downloads_correctly(testapp, workbook):
    response = testapp.get('/batch_download/type%3DExperiment%26status%3Drevoked%26format%3Djson')
    assert response.body.decode('utf-8') == (
        'http://localhost/metadata/type%3DExperiment%26status%3Drevoked%26format%3Djson/metadata.tsv'
    )

def test_batch_download_ensure_experiment_filter_assay_slims_correctly(testapp, workbook):
    response = testapp.get('%2Fbatch_download%2Ftype%3DExperiment%26assay_slims%3D3D%2Bchromatin%2Bstructure%26format%3Djson')
    assert response.body.decode('utf-8') == (
        'http://localhost/metadata/type%3DExperiment%26assay_slims%3D3D%2Bchromatin%2Bstructure%26format%3Djson/metadata.tsv'
        '\nhttp://localhost/files/ENCFF355OWW/@@download/ENCFF355OWW.hic'
        '\nhttp://localhost/files/ENCFF784GFP/@@download/ENCFF784GFP.hic'
        '\nhttp://localhost/files/ENCFF812THZ/@@download/ENCFF812THZ.hic'
        '\nhttp://localhost/files/ENCFF123HIC/@@download/ENCFF123HIC.txt'
