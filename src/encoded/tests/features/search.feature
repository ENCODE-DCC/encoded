...
Feature: Search
    ...
    Scenario: Search Antibodies
        ...
        And I wait for the content to load
        And I click the element with the css selector ".clear-filters-control a"
        And I wait for the content to load
        And I click the element with the css selector ".facet__expander--header[aria-label='status']"
        And I wait for the content to load
        ...
        When I click the element with the css selector ".clear-filters-control a"
        And I wait for the content to load
        And I click the element with the css selector ".facet__expander--header[aria-label='status']"
        And I wait for the content to load
    ...
    Scenario: Search Experiments
        ...
        And I click the element with the css selector ".facet__expander--header[aria-label="status"]"
        And I wait for the content to load
        And I click the element with the css selector ".facet__expander--header[aria-label="perturbed"]"
        And I wait for the content to load
