...
Feature: Search
    ...
    Scenario: Search Antibodies
        ...
        When I click all elements with the css selector "[data-test='facetcontainer'] .facet-expander[aria-pressed='true']"
        And I wait for the content to load
        And I click the element with the css selector ".facet-expander[aria-label='targets.organism.scientific_name']"
        And I wait for the content to load
        ...
        When I click the element with the css selector ".facet-expander[aria-label='clonality']" 
        And I wait for the content to load
    ...
    Scenario: Search Experiments
        ...
        When I click all elements with the css selector "[data-test='facetcontainer'] .facet-expander[aria-pressed='true']"
        And I wait for the content to load
        And I click the element with the css selector ".facet-expander[aria-label="assay_title"]"
        And I wait for the content to load
        And I click the link to "?type=Experiment&control_type!=*&status=released&perturbed=false&assay_title=TF+ChIP-seq"
        And I wait for the content to load
   ...
   Scenario: Search for Assay term
        ...
        And I click the link to "/search/?type=Experiment&control_type!=*&status=released&perturbed=false"
        And I wait for the content to load
        And I click all elements with the css selector "[data-test='facetcontainer'] .facet-expander[aria-pressed='true']"
        And I wait for the content to load
        And I click the element with the css selector ".facet-expander[aria-label='assay_title']" 
        And I wait for the content to load
    ...
    Scenario: Search for Target of Assay term
        ...
        And I click all elements with the css selector "[data-test='facetcontainer'] .facet-expander[aria-pressed='true']"
        And I wait for the content to load
        And I click the element with the css selector ".facet-expander[aria-label='target.label']" 
        And I wait for the content to load
    ...
    Scenario: Search for Organ term
        ...
        And I click all elements with the css selector "[data-test='facetcontainer'] .facet-expander[aria-pressed='true']"
        And I wait for the content to load
        And I click the element with the css selector ".facet-expander[aria-label='biosample_ontology.organ_slims']"
        And I wait for the content to load
