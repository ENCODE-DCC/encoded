Feature: Antibodies
    ...
    Scenario: Active section
        ...
        Then I should see an element with the css selector "tr[class='odd'],tr[class='even'] > a[href='/antibodies/b199b76a-6c4c-468c-a41f-bc4755618632']" within 1 seconds
        And I should see an element with the css selector "tr[class='odd hidden'],tr[class='even hidden'] > a[href='/antibodies/2c13cc62-987b-4fdf-b726-0535c5e4c78e']"
