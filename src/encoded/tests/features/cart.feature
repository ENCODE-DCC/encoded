...
Feature: Cart
    Scenario: Search result cart toggles:
        ...
        When I press "Data"
        And I click the link to "/search/?type=FunctionalCharacterizationExperiment&type=FunctionalCharacterizationSeries&type=TransgenicEnhancerExperiment&config=FunctionalCharacterizationExperimentFacetGroups&datapoint=false&control_type!=*"
        And I wait for the content to load
