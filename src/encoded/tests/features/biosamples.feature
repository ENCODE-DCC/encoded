Feature: Biosamples
    ...
    Scenario: Active section
        ...
        And I should see "C. ENCODE2 / Chia ENCODE2, UCSC / ENCODE2-Mouse"
        ...
        And I should see an element with the css selector "tr[class='odd hidden'],tr[class='even hidden'] > a[href='/biosamples/4b9c490d-7147-42ff-aa25-9390c9d1e2bf']"
        And I should see exactly one element with the css selector "#table-count" containing the text "71"
