...
def fly_experiment(
    ...
    testapp.patch_json(fastq_file_1['@id'], {'dataset': base_experiment['@id'], 'replicate': replicate_1_1['@id']})
    testapp.patch_json(fastq_file_2['@id'], {'dataset': base_experiment['@id'], 'replicate': replicate_2_1['@id']})
    testapp.patch_json(biosample_1['@id'], {'donor': fly_donor['@id'], 'organism': fly['@id'], 'biosample_ontology': whole_organism['@id']})
    testapp.patch_json(biosample_2['@id'], {'donor': fly_donor['@id'], 'organism': fly['@id'], 'biosample_ontology': whole_organism['@id']})
    testapp.patch_json(library_1['@id'], {'biosample': biosample_1['@id']})
    testapp.patch_json(library_2['@id'], {'biosample': biosample_2['@id']})
    testapp.patch_json(replicate_1_1['@id'], {'library': library_1['@id'], 'experiment': base_experiment['@id']})
    testapp.patch_json(replicate_2_1['@id'], {'library': library_2['@id'], 'experiment': base_experiment['@id']})
    return testapp.get(base_experiment['@id']+'@@index-data') 


def test_fly_isogenic_replicate_type(testapp, fly_experiment):
    assert fly_experiment.json['object']['replication_type']=='isogenic' 


def test_fly_unreplicated_replicate_type(testapp, fly_experiment, replicate_2_1):
    testapp.patch_json(replicate_2_1['@id'], {'status': 'deleted'})
    res = testapp.get(fly_experiment.json['object']['@id']+'@@index-data') 
    assert res.json['object']['replication_type']=='unreplicated' 
 
def test_isogenic_replicate_type(
    testapp,
    base_experiment,
    donor_1,
    donor_2,
...
def test_anisogenic_replicate_type_sex_age_matched(
    testapp, 
    base_experiment, 
    donor_1, 
    donor_2,
...
def test_anisogenic_replicate_type_sex_matched(
    testapp, 
    base_experiment, 
    donor_1, 
    donor_2,
...
def test_anisogenic_replicate_type_age_matched(
    testapp, 
    base_experiment, 
    donor_1, 
    donor_2,
...
def test_anisogenic_replicate_type(
    testapp, 
    base_experiment, 
    donor_1, 
    donor_2,
