...
def prepare_search_term_item():
    requests = {
        ...
        FakeRequest((('searchTerm', ''),
                        ('advancedQuery', '@type:s'))): 'embedded.@type:s',
        ...
        FakeRequest((('searchTerm', r'They don\'t really care about us'),
                        ('advancedQuery', ''))): r'They don\'t really care about us',
...
def test_build_aggregation(build_aggregation_item):
    ...
    for index, arg in enumerate(args):
        ...
        _, agg = build_aggregation(arg[0], arg[1])
        assert agg == actual
