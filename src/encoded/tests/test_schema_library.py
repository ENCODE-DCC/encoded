...
def test_library_nucleic_acid_depleted_in_term(testapp, library_schema_13, library_schema_14):
    ...
    testapp.post_json('/library', library_schema_14, status=201)
    library_schema_14.update({'depleted_in_term_name': ['capped mRNA', 'polyadenylated mRNA']})
    testapp.post_json('/library', library_schema_14, status=422)
