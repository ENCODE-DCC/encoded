...
def test_single_donor(testapp, base_reference_epigenome, donor_1, donor_2, biosample_1, biosample_2, library_1, library_2, replicate_1_1, replicate_2_1, base_experiment_1, base_experiment_2 ):   
    ...
    dataset_list = [base_experiment_1, base_experiment_2]
    testapp.patch_json(base_reference_epigenome['@id'], {'related_datasets':
                                                         [base_experiment_1['@id'],
                                                          base_experiment_2['@id']]})
    print(base_reference_epigenome)
...
'''def test_composite(testapp, base_reference_epigenome, donor_1, donor_2, biosample_1, biosample_2, library_1, library_2, replicate_1_1, replicate_2_1, base_experiment_1, base_experiment_2 ):
    ...
    testapp.patch_json(base_experiment_1['@id'], {'replicates': [replicate_1_1['@id']]})
    testapp.patch_json(base_experiment_2['@id'], {'replicates': [replicate_2_1['@id']]})
