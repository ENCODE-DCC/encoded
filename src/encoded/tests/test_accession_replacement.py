...
# def test_replaced_accession_not_in_name(testapp, human_donor_2):
#     donor1 = testapp.post_json('/human_donor', human_donor_2, status=201).json['@graph'][0]
...
# def test_accession_replacement(testapp, human_donor_2):
#     donor1 = testapp.post_json('/human_donor', human_donor_2, status=201).json['@graph'][0]
#     donor1 = testapp.patch_json(
#         donor1['@id'], {'status': 'replaced'}).json['@graph'][0]

#     donor2 = testapp.post_json('/human_donor', human_donor_2, status=201).json['@graph'][0]
...
# def test_schema_formats(human_donor_2, testapp):
#     url = '/human_donor'
#     # but coudl be any accessoned object
#     donor1 = testapp.post_json(url, human_donor_2, status=201).json['@graph'][0]
