...
@upgrade_step('star_quality_metric', '2', '3')
def star_quality_metric_2_3(value, system):
...
@upgrade_step('star_quality_metric', '3', '4')
def star_quality_metric_3_4(value, system):
    return


@upgrade_step('star_quality_metric', '4', '5')
def star_quality_metric_4_5(value, system):
