...
@upgrade_step('replication_timing_series', '11', '11')
@upgrade_step('treatment_time_series', '10', '11')
@upgrade_step('treatment_concentration_series', '10', '11')
def dataset_10_11(value, system):
    # http://redmine.encodedcc.org/issues/5009
    if 'assay_term_name' in value and \
       value['assay_term_name'] == 'HiC':
        value['chromatin_fragmentation_method'] = 'unknown'
