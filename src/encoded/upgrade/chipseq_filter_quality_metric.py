...
@upgrade_step('chipseq_filter_quality_metric', '3', '4')
def chipseq_filter_quality_metric_3_4(value, system):
    return


@upgrade_step('chipseq_filter_quality_metric', '4', '5')
def chipseq_filter_quality_metric_4_5(value, system):
