...
def check_format(item, path):
    ...
    validate_map = {
        ...
        ('bed', 'encode_elements_H3K27ac'): ['-type=bed9+1', chromInfo, '-as=%s/as/encode_elements_H3K27ac.as' % encValData],
        ('bigBed', 'encode_elements_H3K27ac'): ['-type=bigBed9+1', chromInfo, '-as=%s/as/encode_elements_H3K27ac.as' % encValData],
        ('bed', 'dnase_master_peaks'): ['-type=bed9+1', chromInfo, '-as=%s/as/dnase_master_peaks.as' % encValData],
        ('bigBed', 'dnase_master_peaks'): ['-type=bigBed9+1', chromInfo, '-as=%s/as/dnase_master_peaks.as' % encValData],
        ('bed', 'encode_elements_dnase_tf'): ['-type=bed5+1', chromInfo, '-as=%s/as/encode_elements_dnase_tf.as' % encValData],
        ('bigBed', 'encode_elements_dnase_tf'): ['-type=bigBed5+1', chromInfo, '-as=%s/as/encode_elements_dnase_tf.as' % encValData],
        ('bed', 'bed3+'): ['-type=bed3+', chromInfo],
        ('bigBed', 'bed3+'): ['-type=bigBed3+', chromInfo],
        ('bed', 'unknown'): ['-type=bed3+', chromInfo],
        ('bigBed', 'unknown'): ['-type=bigBed3+', chromInfo],
        ('rcc', None): ['-type=rcc'],
        ('idat', None): ['-type=idat'],
