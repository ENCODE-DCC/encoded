...
def format_app_fileinfo(app, file_dict, exclude=None):
    ''' This function essentially coverts an encoded file object into one that looks like an EDW object
    ...
    for prop in edw_file.FILE_INFO_FIELDS:
        ...
        # special handling of nested properties
            ...
            # other wise we don't understand what is in encoded and need to die.
