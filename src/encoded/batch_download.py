...
_tsv_mapping = OrderedDict([
    ...
    ('Biosample genetic modifications methods', ['replicates.library.biosample.genetic_modifications.method']),
    ('Biosample genetic modifications categories', ['replicates.library.biosample.genetic_modifications.category']),                                   
    ('Biosample genetic modifications targets', ['replicates.library.biosample.genetic_modifications.modified_site_by_target_id.name']),                                   
    ('Biosample genetic modifications gene targets', ['replicates.library.biosample.genetic_modifications.modified_site_by_gene_id.name']),                                   
    ('Biosample genetic modifications site coordinates', ['replicates.library.biosample.genetic_modifications.modified_site_by_coordinates.assembly',
                                                          'replicates.library.biosample.genetic_modifications.modified_site_by_coordinates.chromosome',
                                                          'replicates.library.biosample.genetic_modifications.modified_site_by_coordinates.start',
                                                          'replicates.library.biosample.genetic_modifications.modified_site_by_coordinates.end']),                                   
    ('Biosample genetic modifications zygosity', ['replicates.library.biosample.genetic_modifications.zygosity']), 
