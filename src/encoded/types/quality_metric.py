...
class StarQualityMetric(ItemWithAttachment, QualityMetric):
...
class FastqcQualityMetric(QualityMetric, ItemWithAttachment):
...
class BigwigcorrelateQualityMetric(ItemWithAttachment, QualityMetric):
...
class DnasePeakQualityMetric(ItemWithAttachment, QualityMetric):
...
class EdwbamstatsQualityMetric(ItemWithAttachment, QualityMetric):
...
class EdwcomparepeaksQualityMetric(ItemWithAttachment, QualityMetric):
...
class HotspotQualityMetric(ItemWithAttachment, QualityMetric):
...
class IdrSummaryQualityMetric(ItemWithAttachment, QualityMetric):
...
class MadQualityMetric(ItemWithAttachment, QualityMetric):
...
class PbcQualityMetric(ItemWithAttachment, QualityMetric):
...
class PhantompeaktoolsSppQualityMetric(ItemWithAttachment, QualityMetric):
...
class SamtoolsFlagstatsQualityMetric(ItemWithAttachment, QualityMetric):
...
class SamtoolsStatsQualityMetric(ItemWithAttachment, QualityMetric):
