...
class Experiment(Dataset,
    ...
    embedded = Dataset.embedded + [
        ...
        'replicates.library.biosample.originated_from.characterizations.award',
        'replicates.library.biosample.originated_from.characterizations.lab',
        'replicates.library.biosample.originated_from.characterizations.submitted_by',
        'replicates.library.biosample.originated_from.constructs.documents',
        'replicates.library.biosample.originated_from.constructs.documents.award',
        'replicates.library.biosample.originated_from.constructs.documents.lab',
        'replicates.library.biosample.originated_from.constructs.documents.submitted_by',
        'replicates.library.biosample.originated_from.documents',
        'replicates.library.biosample.originated_from.documents.award',
        'replicates.library.biosample.originated_from.documents.lab',
        'replicates.library.biosample.originated_from.documents.submitted_by',
        'replicates.library.biosample.originated_from.talens.documents',
        'replicates.library.biosample.originated_from.talens.documents.award',
        'replicates.library.biosample.originated_from.talens.documents.lab',
        'replicates.library.biosample.originated_from.talens.documents.submitted_by',
        'replicates.library.biosample.originated_from.rnais.documents',
        'replicates.library.biosample.originated_from.rnais.documents.award',
        'replicates.library.biosample.originated_from.rnais.documents.lab',
        'replicates.library.biosample.originated_from.rnais.documents.submitted_by',
        'replicates.library.biosample.originated_from.donor.documents',
        'replicates.library.biosample.originated_from.donor.documents.award',
        'replicates.library.biosample.originated_from.donor.documents.lab',
        'replicates.library.biosample.originated_from.donor.documents.submitted_by',
        'replicates.library.biosample.originated_from.donor.characterizations',
        'replicates.library.biosample.originated_from.donor.characterizations.award',
        'replicates.library.biosample.originated_from.donor.characterizations.lab',
        'replicates.library.biosample.originated_from.donor.characterizations.submitted_by',
        'replicates.library.biosample.originated_from.treatments.documents',
        'replicates.library.biosample.originated_from.treatments.documents.award',
        'replicates.library.biosample.originated_from.treatments.documents.lab',
        'replicates.library.biosample.originated_from.treatments.documents.submitted_by',
                    ...
                    if 'biosample' in libraryObject:
                        ...
                        if biosampleObject['accession'] not in biosample_accessions:
                            ...
                            if 'originated_from' in biosampleObject:
                                originated_from_object = request.embed(
                                    biosampleObject['originated_from'],
                                    '@@object')
