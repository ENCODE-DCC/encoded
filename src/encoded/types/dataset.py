...
class Series(Dataset):
    ...
    embedded = Dataset.embedded + [
        ...
        'related_datasets.files.analysis_step_version.analysis_step.versions.software_versions',
        'related_datasets.files.analysis_step_version.analysis_step.versions.software_versions.software',
        'related_datasets.files.analysis_step_version.software_versions',
        'related_datasets.files.analysis_step_version.software_versions.software',
