...
accession_re = re.compile(r'^KCE(FF|SR|AB|BS|DO|GM|LB|PL|PT|SX)[0-9][0-9][0-9][A-Z][A-Z][A-Z]$')
test_accession_re = re.compile(r'^TST(FF|SR|AB|BS|DO|GM|LB|PL|PT|SX)[0-9][0-9][0-9]([0-9][0-9][0-9]|[A-Z][A-Z][A-Z])$')
