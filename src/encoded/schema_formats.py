...
accession_re = re.compile(r'^KCE(FF|BS|LB|PL|PT|SX|BE)[0-9][0-9][0-9][A-Z][A-Z][A-Z]$')
test_accession_re = re.compile(r'^TST(FF|BS|LB|PL|PT|SX|BE)[0-9][0-9][0-9]([0-9][0-9][0-9]|[A-Z][A-Z][A-Z])$')
