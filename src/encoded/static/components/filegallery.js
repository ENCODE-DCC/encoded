...
function qcAbbr(qc) {
    ...
    const qcAbbrMap = {
        AtacDuplicationQualityMetric: 'DS',
        AtacFRiPQualityMetric: 'FR',
        AtacPbcQualityMetric: 'PB',
        AtacReproducibilityQualityMetric: 'RP',
        AtacXcorScoreQualityMetric: 'XC',
        AtaqcQualityMetric: 'AQ',
