                    ...
                    {!this.state.collapsed ?
                        <tbody>
                            {pairedKeys.map((pairedKey, j) => {
                                ...
                                // library
                                const spanned = [
                                    <td key="br" rowSpan={groupFiles.length} className={`${bottomClass} merge-right table-raw-merged`}>
                                        {groupFiles[0].biological_replicates.length ? <span className="table-raw-biorep">groupFiles[0].biological_replicates[0]</span> : <i>N/A</i>}
                                    </td>,
