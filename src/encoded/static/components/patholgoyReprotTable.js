                ...
                (< div >
                    ...
                    <PanelBody>
                        <dl className="key-value">
                            ...
                            <hr></hr>
                            {this.filteredData[i].metasis_details.site &&  <div data-test="metasis_details.site">
                                <dt>Metasis Details Site</dt>
                                <dd>{this.filteredData[i].metasis_details.site}</dd>
                            </div>}
                            {this.filteredData[i].metasis_details.type && <div data-test="metasis_details.type">
                                <dt>Metasis Details Type</dt>
                                <dd>{this.filteredData[i].metasis_details.type}</dd>
                            </div>}

                            {/* {this.filteredData[i].metasis_details.site && <div>
                                <dt>Metasis details Site</dt>
                                <dd>{this.filteredData[i].metasis_details.site}</dd>
                            </div>}
                            {this.filteredData[i].metasis_details.type && <div>
                                <dt>Metasis details Type</dt>
                                <dd>{this.filteredData[i].metasis_details.type}</dd>
                            </div>} */}
                        </dl>
