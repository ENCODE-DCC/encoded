...
class LabChart extends React.Component {
    ...
    render() {
        return (<div>
            <link rel="stylesheet" href="labchart.css" />
            <div className="flex-container" style={{"display": "flex", "flexFlow": "row wrap"}}>
                <div className="chart-menu" style={{"flexGrow": 0, "justifyContent": "center"}}>
                    <h4>Show/Hide Lab Results</h4>
                    <div className="chart-checkboxes pb-2" style={{"paddingLeft": "10%", "paddingBottom": "10px"}}>{this.state.checkboxes}</div>
                    {/* zoom in and out buttons */}
                    <div className="pt-2" style={{"paddingTop": "10px"}}>
                        <button className="mr-2" style={{"marginRight": "10px"}} onClick={this.zoomIn}>Zoom In</button>
                        <button onClick={this.zoomOut}>Zoom Out</button>
                    </div>
                </div>
                <div className="chart-main" style={{"flexGrow": 12}}>
                    <div className="chart-title" style={{"textAlign": "center"}}><h3>Lab Results Over Time</h3></div>
                    <div id={this.props.chartId} className="chart-area" style={{"height": "900px"}}>
