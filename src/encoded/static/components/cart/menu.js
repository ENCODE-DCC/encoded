 ...
 */
const CartMenuComponent = ({ elements, savedCartObj, inProgress, openDropdown, dropdownClick, loggedIn }) => {
...
CartMenuComponent.defaultProps = {
    elements: [],
    savedCartObj: null,
    openDropdown: '',
    dropdownClick: null,
...
const CartMenuInternal = connect(mapStateToProps)(CartMenuComponent);
 ...
 */
const CartMenu = ({ openDropdown, dropdownClick }, reactContext) => (
    <CartMenuInternal
        openDropdown={openDropdown}
        dropdownClick={dropdownClick}
