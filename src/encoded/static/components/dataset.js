    ...
    return (
        ...
        >
            {diseaseDatasets.length > 0 ?
                <>
                    <div className="experiment-table__subheader">{`${diseaseTerm.uppercaseFirstChar()} samples in series`}</div>
                    <SortTable
            ...
            {noDiseaseDatasets.length > 0 ?
                <>
                    <div className="experiment-table__subheader">Non-diseased experiments in series</div>
                    <SortTable
