            ...
            <div className="matrix-header__controls">
                <div className="matrix-header__filter-controls">
                    <div className="test-project-selector">
                        <input type="radio" id="allDeeplyProfiled" name="data-selection" value="All" checked={isAllDeeplyMatrix(pageUrl)} onChange={() => switchDeeplyProfilePageType(true, pageUrl)} />
                        <label htmlFor="allDeeplyProfiled">All</label> &nbsp; &nbsp;
                        <input type="radio" id="deeplyProfiled" name="data-selection" value="DeeplyProfiled" checked={!isAllDeeplyMatrix(pageUrl)} onChange={() => switchDeeplyProfilePageType(false, pageUrl)} />
 ...
 */
class DeeplyProfiledMatrix extends React.Component {
    constructor() {
        super();
...
DeeplyProfiledMatrix.propTypes = {
    context: PropTypes.object.isRequired,
};

DeeplyProfiledMatrix.contextTypes = {
