            ...
            <div className="matrix-header__controls">
                <div className="matrix-header__filter-controls">
                    <div className="test-project-selector">
                        <input type="radio" id="allDeeplyProfiled" name="data-selection" value="All" checked={isAllDeeplyMatrix(pageUrl)} onChange={() => switchDeeplyProfilePageType(true, pageUrl, reactContext.navigate)} />
