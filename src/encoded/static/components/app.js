    ...
    global_sections: [
        {
            ...
            children: [
                ...
                { id: 'exp-report', title: 'Dataset report', url: '/report/?type=Dataset', tag: 'collection' },
                { id: 'lib-report', title: 'Library report', url: '/report/?type=Library', tag: 'collection' },
                { id: 'sep-mm-0' },
                { id: 'samples', title: 'Sample data' },
                { id: 'donor-repoprt', title: 'Donor report', url: '/report/?type=HumanDonor', tag: 'collection' },
                { id: 'tissue-report', title: 'Tissue report', url: '/report/?type=Tissue', tag: 'collection' },
                { id: 'organoid-report', title: 'Organoid report', url: '/report/?type=Organoid', tag: 'collection' },
                { id: 'culture-report', title: 'Culture report', url: '/report/?type=CellCulture', tag: 'collection' },
                { id: 'suspension-report', title: 'Suspension report', url: '/report/?type=Suspension', tag: 'collection' },
                { id: 'sep-mm-1' },
