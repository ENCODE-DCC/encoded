    ...
    global_sections: [
        {
            ...
            children: [
                ...
                { id: 'exp-report', title: 'Experiment report', url: '/report/?type=Experiment&status=released', tag: 'collection' },
                { id: 'lib-report', title: 'Library report', url: '/report/?type=Library&status=released', tag: 'collection' },
                { id: 'sep-mm-0' },
                { id: 'samples', title: 'Sample data' },
                { id: 'donor-repoprt', title: 'Donor report', url: '/report/?type=HumanDonor&status=released', tag: 'collection' },
                { id: 'tissue-report', title: 'Tissue report', url: '/report/?type=Tissue&status=released', tag: 'collection' },
                { id: 'organoid-report', title: 'Organoid report', url: '/report/?type=Organoid&status=released', tag: 'collection' },
                { id: 'culture-report', title: 'Culture report', url: '/report/?type=CellCulture&status=released', tag: 'collection' },
                { id: 'suspension-report', title: 'Suspension report', url: '/report/?type=Suspension&status=released', tag: 'collection' },
                { id: 'sep-mm-1' },
