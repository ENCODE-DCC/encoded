                ...
                <div className="container">
                    <div id="footer-links">
                        <ul>
                            ...
                            <li className="hidden-phone">&copy;<noscript>2014</noscript><script>document.write(new Date().getFullYear())</script>. Stanford University.</li>
                        </ul>
                    </div>
                    <div id="footer-logos">
                        <ul>
                    ...
                    <p className="visible-phone" id="phone-copy">&copy;<noscript>2014</noscript><script>document.write(new Date().getFullYear())</script>. Stanford University.</p>
