...
/** Switch page */
const switchDeeplyProfilePageType = (isAll, pageUrl) => {
            ...
            <div className="matrix-header__controls">
                <div className="matrix-header__filter-controls">
                    <div className="test-project-selector">
                        <input type="radio" id="allDeeplyProfiled2" name="data-selection" value="All" checked={isAllDeeplyMatrix(pageUrl)} onChange={() => switchDeeplyProfilePageType(true, pageUrl)} />
