...
describe('LinkWithHover', () => {
    ...
    test('has null classname', () => {
        ...
        expect(link.find('button').props().className).toBeNull();
    });
    ...
    test('renders default classname', () => {
        ...
        expect(link.find('button').props().className).toEqual('default-class');
    });
    ...
    test('renders hover class when hovered', () => {
        ...
        expect(link.find('button').props().className).toEqual('hover-class');
    });
