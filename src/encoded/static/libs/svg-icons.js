...
var icons = {
    ...
    summary: <svg id="Summary" data-name="Summary" xmlns="http://www.w3.org/2000/svg" width="29" height="17" viewBox="0 0 29 17" className="svg-icon svg-icon-summary"><title>summary-icon</title><polygon points="18.06 10 9.72 7.09 1.05 16 1 16 1 0 0 0 0 17 29.03 17 29.03 0 18.06 10"/></svg>,
