...
// Spinner for browsers that don't support SVG animations
const spinnerStatic = (
    <svg
        id="Static Spinner"
        data-name="Static Spinner"
        version="1.1"
        xmlns="http://www.w3.org/2000/svg"
        width="100%"
        height="100%"
        viewBox="40 160 520 520"
        className="svg-icon svg-icon-spinner-static"
    >
        <path
            fill="#000"
            d="M300.8,644.7c-0.1,0-0.2,0-0.3,0c-29.3,0-57.8-5.7-84.7-16.8l18.4-44.4c21.1,8.7,43.5,13.2,66.5,13.2l0.6,0
            c-0.2,0-0.3,0-0.5,0L300.8,644.7z M385.7,627.9l-18.4-44.3c21.2-8.8,40.1-21.5,56.4-37.8l34,33.9C437,600.4,412.7,616.6,385.7,627.9
            z M143.7,579.8c-20.8-20.7-37-45-48.2-72l44.3-18.4c8.8,21.2,21.5,40.1,37.8,56.4L143.7,579.8z M505.9,507.7l-44.3-18.4
            c8.8-21.1,13.2-43.5,13.2-66.6v-0.4h48v0.4C522.7,452.1,517,480.7,505.9,507.7z M126.6,422.9h-48l0-0.2c0-29.3,5.6-57.8,16.8-84.8
            l44.4,18.3c-8.7,21.1-13.1,43.4-13.1,66.4L126.6,422.9z M461.4,355.7c-8.8-21.1-21.6-40.1-37.9-56.4l33.9-34
            c20.8,20.7,37.1,44.9,48.3,71.9L461.4,355.7z M177.4,299.8l-34-33.9c20.7-20.8,44.9-37,71.9-48.3l18.5,44.3
            C212.6,270.7,193.6,283.4,177.4,299.8z M367,261.7c-21-8.7-43.4-13.1-66.3-13.1l-0.3,0v-48l0.3,0c29.3,0,57.8,5.6,84.6,16.7
            L367,261.7z"
        />
    </svg>
);
