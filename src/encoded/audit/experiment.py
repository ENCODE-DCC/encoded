...
def audit_experiment_isogeneity(value, system):
    ...
    for rep in value['replicates']:
        ...
        if bio_rep_num not in biological_rep_biosample_dict:
    ...
    #  To allow validation of biological replicates -
    #  first make sure technical replicates are from the same donor
