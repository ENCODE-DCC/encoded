...
ANNOTATION_METADATA_COLUMN_TO_FIELDS_MAPPING = OrderedDict(
    [
        ...
        ('File format', ['files.file_type']),
        ('Output type', ['files.output_type']),
        ('Assay term name', ['files.dataset_details.assay_term_name']),
...
PUBLICATION_DATA_METADATA_COLUMN_TO_FIELDS_MAPPING = OrderedDict(
    [
        ...
        ('Assay term name', ['files.dataset_details.assay_term_name']),
        ('Biosample term id', ['files.dataset_details.biosample_ontology.term_id']),
        ('Biosample term name', ['files.dataset_details.biosample_ontology.term_name']),
        ('Biosample type', ['files.dataset_details.biosample_ontology.classification']),
        ('File target', ['files.dataset_details.target.label']),
        ('Dataset accession', ['accession']),
        ('Dataset date released', ['date_released']),
        ('Project', ['award.project']),
        ('Lab', ['files.lab.title']),
