...
SNOVAULT_DEP = "git+https://github.com/ENCODE-DCC/snovault.git@pin-antlr"
...
INSTALL_REQUIRES = [
    ...
    "rfc3987==1.3.8",
    "rutter==0.2",
    "subprocess_middleware @ git+https://github.com/ottojolanki/subprocess_middleware.git@master",
    "transaction==3.0.0",
    "waitress==1.4.3",
    "xlrd==1.2.0",
