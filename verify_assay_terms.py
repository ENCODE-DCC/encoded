import json
# from assay_data.py import assay_terms
...
for assay in assay_terms.keys():
    ...
    name_from_ontology_json = ont[id_from_assay_data]['name']
    preferred_name_from_ontology = ont[id_from_assay_data]['preferred_name']
    synonyms_from_ontology = ont[id_from_assay_data]['synonyms']
